    ...
    6: [function (require, module, exports) {
        ...
        function clockwiseGeometry(object, options) {
            ...
            type({
                ...
                Polygon: function (polygon) {
                    clockwisePolygon(polygon.coordinates);
                },
                MultiPolygon: function (multiPolygon) {
                    multiPolygon.coordinates.forEach(clockwisePolygon);
                }
            }).object(object);
        ...
        function clockwiseTopology(topology, options) {
            ...
            var clockwise = type({
                ...
                MultiPoint: noop,
                Polygon: function (polygon) {
                    clockwisePolygon(polygon.arcs);
                },
                MultiPolygon: function (multiPolygon) {
                    multiPolygon.arcs.forEach(clockwisePolygon);
                }
            });
            ...
            function ringArea(ring) {
                return system.ringArea(topojson.feature(topology, {
                    type: "Polygon",
                    arcs: [ring]
...
// feature should not have an id.
        module.exports = function (objects, id) {
            if (arguments.length < 2) id = function (d) {
                return d.id;
            };
            ...
            var idObjectType = {
                ...
                FeatureCollection: function (collection) {
                    collection.features.forEach(idFeature);
                }
            };
    ...
    15: [function (require, module, exports) {
        ...
        module.exports = function (topology, options) {
            var minimumArea = 0,
                ...
                verbose = false,
                system = null,
                N = topology.arcs.reduce(function (p, v) {
                    return p + v.length;
                }, 0),
                M = 0;
            ...
            if (retainProportion) {
                ...
                options["minimum-area"] = minimumArea = N ? areas.sort(function (a, b) {
                    return b - a;
                })[Math.ceil((N - 1) * retainProportion)] : 0;
    ...
    18: [function (require, module, exports) {
        ...
        module.exports = function (objects, options) {
            var Q = 1e4, // precision of quantization
                id = function (d) {
                    return d.id;
                }, // function to compute object id
                propertyTransform = function () {
                }, // function to transform properties
                transform,
                minimumArea = 0,
                stitchPoles = true,
                verbose = false,
            ...
            if (Q) {
                ...
                if (verbose) {
                    console.warn("quantization: " + transform.scale.map(function (degrees) {
                        return system.formatDistance(degrees / 180 * Math.PI);
                    }).join(" "));
                }
            }
            ...
            if (verbose) {
                console.warn("topology: " + topology.arcs.length + " arcs, " + topology.arcs.reduce(function (p, v) {
                    return p + v.length;
                }, 0) + " points");
            }
...
// properties hash will be deleted from the current feature.
        module.exports = function (objects, propertyTransform) {
            ...
            var transformObjectType = {
                ...
                FeatureCollection: function (collection) {
                    collection.features.forEach(transformFeature);
                }
            };
...
var convertGeojsonToTopojson = function (geojsonString) {
    ...
    return JSON.stringify(topojsonOutput, null, 4);
};